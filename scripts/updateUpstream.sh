...
echo "  - $(bashcolor 1 32)2$(bashcolorend) : Hydrinity"
echo "----------------------------------------"
# SCRIPT HEADER end
...
# After the patching, it will copying sources that do no exist in the hydrinity workspace but referenced in hydrinity patches into our workspace, depending on the content of our patches, this will be addressed by calling importSources.sh.
...
echo "  $(bashcolor 1 32)($subtasks/$subtasks) Succeed$(bashcolorend) - Submodules have been updated, regenerated and imported, run 'hydrinity patch' to test/fix patches, and by 'hydrinity rbp' to rebuild patches that fixed with the updated upstream."
echo "  "
